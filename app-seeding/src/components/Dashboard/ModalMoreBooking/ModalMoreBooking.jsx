  ...
  return isShowing && element === 'ModalMoreBooking'
    ? ReactDOM.createPortal(
        <>
          <div>
            <div className="modal">
              <div className="modal__box modal__box--more">
                      ...
                      <div className="modal__info--bot">
                        <div className="modal__aside">
                          ...
                          <div className="modal__infoContentItem">
                            ...
                            <div className="modal__infoValue">{data[0].line_ids.join(', ')}</div>
                          </div>
                          <div className="modal__infoContentItem">
                        ...
                        <div className="modal__aside">
                          ...
                          <div className="modal__infoContentItem">
                            <div className="modal__infoLabel">Thương hiệu:</div>
                            <div className="modal__infoValue">{data[0].brand}</div>
                          </div>
                          <div className="modal__infoContentItem">
                            <div className="modal__infoLabel">Chi nhánh:</div>
                            <div className="modal__infoValue">{data[0].company}</div>
                          </div>
                          <div className="modal__infoContentItem">
                            <div className="modal__infoLabel">Ghi chú:</div>
                            <div className="modal__infoValue">{data[0].note}</div>
                          </div>
                        </div>
                      </div>
                    </div>
